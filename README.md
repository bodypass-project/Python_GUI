...
* **BODYPASScatalog.json**: Metrics to included in the dictionary and stored by the system to well-define a metric. For any metric, the system stores the following:

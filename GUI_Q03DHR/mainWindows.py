...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.butLoadFile.setStyleSheet("font-weight: normal;border: 2px solid #8f8f91; border-radius: 10px; background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #c0c0c0, stop: 1 #babbbe);")
        self.butLoadFile.setObjectName("butLoadFile")
        self.formLayout.setWidget(10, QtWidgets.QFormLayout.SpanningRole, self.butLoadFile)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.SpanningRole, self.lFilename)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.butLoadFile.setText(_translate("MainWindow", "Load file"))
        self.lFilename.setText(_translate("MainWindow", "File not loaded"))
